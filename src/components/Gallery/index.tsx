...
const galleryItems = [
  ...
  { src: images.oceanViewTerrace, alt: 'Terrace with extensive sea views', className: 'standard' },
  { src: images.poolWithSeaView, alt: 'Private pool overlooking the Mediterranean Sea', className: 'standard' },
  { src: images.poolsideTerraceMountainView, alt: 'Poolside terrace with a view towards the Mijas mountains', className: 'wide' },
  ...
  { src: images.livingOverview, alt: 'Main lounge with a 55-inch Smart TV, fireplace and air conditioning', className: 'standard' },
  ...
  { src: images.livingRoomTvWorkspace, alt: 'Living room with a 55-inch Smart TV and workspace', className: 'standard' },
